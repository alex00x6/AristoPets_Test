...
public class TestListener implements ITestListener {
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        String seleniumGridIp = iTestContext.getCurrentXmlTest().getParameter("seleniumGridIp");
        ...
        Boolean bUseGrid = useGrid.contentEquals("true");
        WebDriver driver = DriverConfigurator.createInstance(seleniumGridIp, browserName, bUseGrid);
